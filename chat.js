...
function CatchupChat({ onBack }) {
  ...
  return (
    <div className="fixed inset-0 bg-white flex flex-col" style={{ width: '100vw', height: '100vh', overflow: 'hidden' }}>
      {/* Header - Fixed */}
      <div className="flex items-center justify-between px-3 py-2 bg-white border-b border-gray-200" style={{ flexShrink: 0 }}>
        <button 
          onClick={onBack}
      ...
      {/* Reply Bar - Fixed */}
      {replyingTo && (
        <div className="bg-white px-4 py-2" style={{ flexShrink: 0 }}>
          <div 
      ...
      {/* Input Bar - Fixed */}
      <div className={`bg-white ${!replyingTo ? 'border-t border-gray-200' : ''}`} style={{ flexShrink: 0 }}>
        <div className="flex items-center p-2 gap-1">
          ...
          <div
            ref={inputRef}
            contentEditable
            className="flex-1 bg-transparent text-gray-900 outline-none px-3 py-2 overflow-y-auto whitespace-pre-wrap break-words"
          ...
          <button className="p-2 flex-shrink-0 self-end transition-all duration-200" style={{
            opacity: hasText ? 0 : 1,
            transform: hasText ? 'scale(0)' : 'scale(1)',
            pointerEvents: hasText ? 'none' : 'auto',
            width: hasText ? 0 : '40px'
          }}>
          ...
          <button 
            ...
            style={{
              opacity: hasText ? 1 : 0,
              transform: hasText ? 'scale(1)' : 'scale(0)',
              pointerEvents: hasText ? 'auto' : 'none',
              width: hasText ? '40px' : 0
            }}
          >
