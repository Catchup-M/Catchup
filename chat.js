    ...
    <div className="fixed inset-0 bg-white z-50 flex flex-col slide-in-right">
      ...
      <div className={`bg-white flex-shrink-0 ${!replyingTo ? 'border-t border-gray-200' : ''}`}>
        <div className="w-full max-w-2xl mx-auto flex items-center p-2 gap-1">
          ...
          <button className="p-2 flex-shrink-0 self-end hover:bg-gray-100 rounded-full transition-all duration-200" style={{
            opacity: hasText ? 0 : 1,
            transform: hasText ? 'translateX(10px)' : 'translateX(0)',
            pointerEvents: hasText ? 'none' : 'auto',
            width: hasText ? 0 : 'auto',
      ...
      {/* Emoji Picker - Completely empty grid (all emojis removed) */}
      <div
