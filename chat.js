      ...
      >
        ...
        {layout === 'single' ? (
          ...
          <div className="flex flex-wrap items-end"> 
            ...
            {/* The status block - NOW INCLUDES NEGATIVE TRANSLATE Y */}
            <span 
              ref={timeRef} 
              ...
              style={{ 
                ...
                verticalAlign: 'bottom', 
                color: message.isOutgoing ? '#dbeafe' : '#6b7280',
                // FINAL FIX: Pull the status up 3 pixels to sit flush with the text baseline
                transform: 'translateY(-3px)' 
              }}>
              {message.time}
              {message.isOutgoing && checkmarkSvg}
...
// ... Rest of ChatView component remains the same (omitted for brevity) ...
...
function ChatView({ selectedChat, onBack }) {
  ...
  // useEffects and handlers (omitted for brevity)
