// chat.js - FINAL, FULLY FIXED VERSION
    ...
    <div className={`flex items-end ${message.isOutgoing ? 'justify-end' : ''}`}>
      ...
      >
        ...
        {layout === 'single' ? (
          ...
          <div className="flex flex-wrap items-end" style={{ paddingBottom: '0' }}> 
            ...
            <span 
              style={{ 
                color: message.isOutgoing ? '#ffffff' : '#000000', 
                fontSize: '16px', 
                lineHeight: '1.2', // CHANGED from 1.5 to 1.2
            ...
            */}
            <span 
              ...
              style={{ 
                fontSize: '13px', // CHANGED from 11px to 13px
                lineHeight: '1', // CHANGED from 1.5 to 1
                color: message.isOutgoing ? '#dbeafe' : '#6b7280',
                // Pushing it down slightly for visual alignment
                transform: 'translateY(0px)' // CHANGED from 3px to 0px
              }}>
              {message.time}
              {message.isOutgoing && checkmarkSvg}
            </span>
